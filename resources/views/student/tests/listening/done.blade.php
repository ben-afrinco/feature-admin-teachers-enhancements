...
<div class="card">
  ...
  <div class="header">
    ...
    <p id="desc">أنت على وشك أن تبدأ مهارة الكتابة.</p>
  </div>
  ...
  <div class="footer">
    <!-- ✅ تم التعديل هنا: يروح لصفحة Writing Get Ready -->
    <a class="cta" href="{{ route('writing.getready') }}" id="nextBtn">
...
function toggleLang(){
    if(lang === "en"){
        ...
        document.getElementById("desc").innerText = "أنت على وشك أن تبدأ مهارة الكتابة.";
        ...
        document.getElementById("desc").innerText = "You are about to start the writing section.";
