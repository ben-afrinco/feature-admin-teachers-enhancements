...
<title>Listening - Get Ready</title>
...
<div class="card">
  ...
  <div class="header">
    <h1 id="title">Listening</h1>
    <p class="sub" id="subtitle">You are about to start the listening section.</p>
  </div>

  <div class="mid">
    <img src="{{ asset('images/listening.png') }}" alt="Listening Icon">
    <p class="mid-title" id="midName">Listening</p>
  ...
  <div class="list">
    <ul id="rules">
      ...
      <li>Read the questions before starting the audio. You can listen to each audio clip two times.</li>
      <li>Once you submit a task, you cannot go back.</li>
    </ul>
  </div>

  <!-- ✅ الانتقال إلى listeningQ1.blade.php -->
  <a href="{{ route('listening.q1') }}" class="btn btn-primary start" id="startBtn">Start</a>
...
function setArabic(){
  document.getElementById('title').innerText = "الاستماع";
  document.getElementById('subtitle').innerText = "أنت على وشك بدء قسم الاستماع.";
  document.getElementById('midName').innerText = "الاستماع";
  ...
  document.getElementById('rules').innerHTML = `
    ...
    <li>اقرأ الأسئلة قبل تشغيل الصوت. يمكنك الاستماع لكل مقطع صوتي مرتين.</li>
...
function setEnglish(){
  ...
  document.getElementById('subtitle').innerText = "You are about to start the listening section.";
  document.getElementById('midName').innerText = "Listening";
