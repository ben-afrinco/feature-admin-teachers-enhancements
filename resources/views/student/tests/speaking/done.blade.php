...
<title>Completed - LingoPulse</title>
...
<button class="translate-btn" onclick="toggleLang()" id="translateBtn">English</button>

<div class="card">

  <div class="header">
    <h1 id="title">أحسنت! لقد أنهيت كل المهارات.</h1>
    <p id="desc">انتقل إلى إظهار النتيجة.</p>
  </div>
  ...
  <div class="strip">
    <div class="skills">
      ...
      <div class="skill">
        ...
        <strong id="readingText">القراءة</strong>
        <span>20 mins</span>
      </div>
      ...
      <div class="skill">
        ...
        <strong id="listeningText">الاستماع</strong>
        <span>20 mins</span>
      </div>
      ...
      <div class="skill">
        ...
        <strong id="writingText">الكتابة</strong>
        <span>35 mins</span>
      </div>

      <!-- ✅ Speaking (صار عليه صح) -->
      <div class="skill">
        <div class="icon-wrap">
          <div class="checkCircle">✔</div>
        </div>
        <strong id="speakingText">المحادثة</strong>
        <span>15 mins</span>
      </div>
  ...
  <div class="footer">
    <!-- ✅ ينتقل إلى results.blade.php -->
    <a class="cta" href="{{ route('test.results') }}" id="nextBtn">
      إظهار النتيجة
    </a>
  </div>
...
function toggleLang(){
  if(lang === "ar"){
    // English
    document.getElementById("title").innerText = "Well done! You have completed all skills.";
    document.getElementById("desc").innerText = "Proceed to view your results.";
    ...
    // Arabic
    document.getElementById("title").innerText = "أحسنت! لقد أنهيت كل المهارات.";
    document.getElementById("desc").innerText = "انتقل إلى إظهار النتيجة.";
    ...
    document.getElementById("nextBtn").innerText = "إظهار النتيجة";
