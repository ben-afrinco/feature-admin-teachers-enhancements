...
<div class="card">
  ...
  <div class="header">
    <h1 id="title">أحسنت!</h1>
    <p id="desc">أنت على وشك أن تبدأ مهارة التحدث.</p>
  </div>
  ...
  <div class="strip">
    <div class="skills">
      ...
      <!-- ✅ Writing: صح (تم تحويلها من صورة إلى صح) -->
      <div class="skill">
        <div class="icon-wrap">
          <div class="checkCircle">✔</div>
        </div>
  ...
  <div class="footer">
    <!-- ✅ يروح لصفحة Speaking Get Ready -->
    <a class="cta" href="{{ route('speaking.getready') }}" id="nextBtn">
...
function toggleLang(){
  if(lang === "ar"){
    ...
    document.getElementById("desc").innerText = "You are about to start the speaking section.";
    ...
    document.getElementById("desc").innerText = "أنت على وشك أن تبدأ مهارة التحدث.";
